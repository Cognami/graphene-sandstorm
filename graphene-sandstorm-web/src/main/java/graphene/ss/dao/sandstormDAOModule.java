...
import graphene.ss.dao.impl.GraphTraversalRuleServiceImpl;
import graphene.ss.dao.impl.IconServiceImpl;
import graphene.ss.dao.impl.es.DataSourceListDAOESImpl;
import graphene.ss.web.services.sandstormStartupProceduresImpl;
...
public class sandstormDAOModule {
	private static Logger logger = LoggerFactory.getLogger(sandstormDAOModule.class);
	...
	public static void bind(final ServiceBinder binder) {
		...
		// binder.bind(G_DataAccess.class, sandstormDataAccess.class);
		...
		binder.bind(StartupProcedures.class, sandstormStartupProceduresImpl.class);
