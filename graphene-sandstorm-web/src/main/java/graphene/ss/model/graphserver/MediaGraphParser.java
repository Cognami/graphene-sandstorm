package graphene.ss.model.graphserver;

import graphene.dao.G_Parser;
import graphene.ss.model.media.CommentData;
import graphene.ss.model.media.LikeData;
import graphene.ss.model.media.Media;
 ...
 */
public class MediaGraphParser extends sandstormParser<Media> {
	...
	// This method creates a sub graph of the nodes inside a sandstorm media
	// page, and a list
