 ...
 * service definitions.
 */
@SubModule({ sandstormDAOModule.class, AppRestModule.class, NoSecurityModule.class, GraphServerModule.class,
...
public class AppModule {
	...
	public static void contributeApplicationDefaults(final MappedConfiguration<String, Object> configuration) {
		...
		configuration.add(G_SymbolConstants.EXT_PATH, "/graphene-sandstorm-web/graph.html?&entity=");
