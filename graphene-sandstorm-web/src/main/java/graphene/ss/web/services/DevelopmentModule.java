...
import graphene.ss.dao.sandstormDAOModule;
import graphene.ss.model.graphserver.GraphServerModule;
 ...
 */
@SubModule({ sandstormDAOModule.class, AppRestModule.class, GraphServerModule.class, GrapheneModule.class,
...
public class DevelopmentModule {
	...
	public static void contributeApplicationDefaults(final MappedConfiguration<String, Object> configuration) {
		configuration.add(G_SymbolConstants.APPLICATION_NAME, "Graphene-sandstorm Mock");
		configuration.add(G_SymbolConstants.APPLICATION_CONTACT, "sandstorm");
